...
CREATE TABLE IF NOT EXISTS public.experiences (
  ...
  price_options DECIMAL(10,2)[] DEFAULT '{}',
...
INSERT INTO public.experiences (
  title, short_description, full_description, category, occasions, starting_price, 
  currency, vendor_id, location, featured_image, duration, difficulty_level, 
  status, is_featured, included_items, rating, total_bookings
) VALUES
(
